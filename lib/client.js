		...
		function ModelRow(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					probeResult ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dpp-probe-result " + (probeResult.status === "success" ? "dpp-probe-ok" : "dpp-probe-fail"),
						children: probeResult.status === "success" ? `${probeResult.firstTokenMs ?? "—"}ms / ${probeResult.totalMs ?? "—"}ms / ${probeResult.finishReason ?? "—"}` : `${probeResult.failure?.code ?? "ERR"}: ${probeResult.failure?.message ?? ""}`
					}) : null
				]
			});
		}
				...
				children: [
					...
					Array.isArray(profile.models) && profile.models.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: t("models")
						}), profile.models.map((model, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelRow, {
							route,
							model,
							modelIndex: idx,
							revision,
