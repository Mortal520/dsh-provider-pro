		...
		*/
		async function sendProbeRequest(api, provider, model, events, mode) {
			...
			const answer = await new Promise((resolve) => {
				...
				timer = setTimeout(() => done(void 0), 12e3);
				readSlot().then((value) => {
			...
			if (!answer.ok) return {
				...
				failure: {
					code: answer.mode === "capabilities" && answer.error !== void 0 ? "CAPABILITIES_FAIL" : answer.imageSupported === false ? "IMAGE_UNSUPPORTED" : "PROBE_FAIL",
			...
			if (answer.totalMs !== void 0) caps.push(`total: ${answer.totalMs}ms`);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: probeBusy ? t("probing") : t("capabilities")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "dpp-probe-btn",
						disabled: probeBusy,
						onClick: () => void runProbe("deep"),
						children: probeBusy ? t("probing") : t("deepProbe")
					}),
